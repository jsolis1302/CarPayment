    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">CAR PAY</a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li> <?php 
                   if (! empty($_SESSION["login"])) 
                      {
                        echo '<a href="php/logout.php" title="Cerrar sesión">'.$_SESSION["login"].'</a>'; 
          ...
          <div ng-app = "myApp" ng-controller ="userController">
            <form action="post">
              ...
              <div>
                ...
                <input class="form-control"  type="text" ng-model ="lname"/>
              </div>
        ...
        $http.post("php/insert_user.php",
                    {   'login':$scope.login,
                         ...
                         'lname': $scope.lname
                                      ...
                                      console.log("data insertered successfully");
                                    });
      }
    });
  </script>
